      ...
      <div className="max-w-lg mx-auto space-y-4 py-6">
        ...
        <Card>
          <CardContent className="space-y-1 text-sm">
            ...
            <p>
              Variables fijo (incl. sub-ítems): ${totalGVarFijo.toLocaleString()} ({percent(totalGVarFijo)}%)
            </p>
            <p>
              Variables var (incl. sub-ítems): ${totalGVarVar.toLocaleString()} ({percentVar(totalGVarVar)}%)
            </p>
